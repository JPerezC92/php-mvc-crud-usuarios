...
<div class="w-full max-w-xs flex flex-col items-center justify-center m-auto border rounded-md border-green-600 py-8">
  ...
  <h2 class="mb-4 text-xl font-bold">Borrar Usuario</h2>

  <form class="flex flex-col items-center justify-center" action="<?php echo RUTA_URL; ?>/paginas/borrar/<?php echo $datos["id_usuario"]; ?>" method="post">
    ...
    <input class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 mt-4 rounded focus:outline-none focus:shadow-outline" type="submit" value="Borrar Usuario">
